...
All exercise solutions are available in the [appendices](chapters/exercise_solutions.qmd). Please attempt the exercises yourself first, making full use of R's built in help files, [cheatsheets](https://posit.co/resources/cheatsheets/) (where available), and example R code in this book. Going straight to the solutions to copy and paste the code without thinking will not help you after the course!
...
For more information about this data, including variable descriptions and sources, see [the appendix](chapters/data_description.qmd).
